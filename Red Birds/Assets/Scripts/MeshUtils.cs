...
public static class MeshUtils
{
    ...
    public static void CreateWing(Mesh mesh, float length, float width_r, float width_t, float offset, float thickness_r, float thickness_t)
    {
        ...
        #region Vertices
        Vector3 p0 = new Vector3(-length, -thickness_t * .5f, width_t * .5f + offset);
        Vector3 p1 = new Vector3(0, -thickness_r * .5f, width_r * .5f);
        Vector3 p2 = new Vector3(0, -thickness_r * .5f, -width_r * .5f);
        Vector3 p3 = new Vector3(-length, -thickness_t * .5f, -width_t * .5f + offset);

        Vector3 p4 = new Vector3(-length, thickness_t * .5f, width_t * .5f + offset);
        Vector3 p5 = new Vector3(0, thickness_r * .5f, width_r * .5f);
        Vector3 p6 = new Vector3(0, thickness_r * .5f, -width_r * .5f);
        Vector3 p7 = new Vector3(-length, thickness_t * .5f, -width_t * .5f + offset);
    ...
    public static void CreateSphere(Mesh mesh, float radius, int nbLong, int nbLat)
    {
        mesh.Clear();
